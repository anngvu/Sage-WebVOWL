...
webvowl.util.ontologyGroups = require("./util/ontologyGroups");
webvowl.util.classHierarchy = require("./util/classHierarchy");
webvowl.modules = {};
...
webvowl.modules.ontologyColorSwitch = require("./modules/ontologyColorSwitch");
webvowl.modules.ontologyFilter = require("./modules/ontologyFilter");
